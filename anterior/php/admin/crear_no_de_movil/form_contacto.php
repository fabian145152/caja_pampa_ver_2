						...
						<div class="container theme-showcase" role="main">
							...
							<form class="form-horizontal" name="formcontato" method="POST" action="MensajeError.php">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="nombres" placeholder="Nombre Completo" <?php
																																...
																																?>>
										<?php
										if (!empty($_SESSION['configuroweb_nombres'])) {
											echo "<p style='color: #f00; '>" . $_SESSION['configuroweb_nombres'] . "</p>";
											unset($_SESSION['configuroweb_nombres']);
										}
										?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="email" class="form-control" name="email" placeholder="Su e-mail" <?php
																														...
																														?>>
										<?php
										if (!empty($_SESSION['configuroweb_email'])) {
											echo "<p style='color: #f00; '>" . $_SESSION['configuroweb_email'] . "</p>";
											unset($_SESSION['configuroweb_email']);
										}
										?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="asunto" placeholder="Asunto de contacto" <?php
																																...
																																?>>
										<?php
										if (!empty($_SESSION['configuroweb_asunto'])) {
											echo "<p style='color: #f00; '>" . $_SESSION['configuroweb_asunto'] . "</p>";
											unset($_SESSION['configuroweb_asunto']);
										}
										?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										?>
										<?php
										if (!empty($_SESSION['configuroweb_mensaje'])) {
											echo "<p style='color: #f00; '>" . $_SESSION['configuroweb_mensaje'] . "</p>";
											unset($_SESSION['configuroweb_mensaje']);
										}
										?>
									</div>
								</div>
