			...
			<div class="row">
				<div class="col-md-12">
					<div class="panel-body">
						...
						$result_msg_contato = "SELECT * FROM completa";
						...
						$result_msg_contatos = "SELECT * FROM completa limit $inicio, $quantidade_pg";
						...
						<div class="container theme-showcase" role="main">
							...
							<div class="row espaco">
								<div class="pull-right">
									...
									&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
									<a href="../../menu.php"><button type='button' class='btn btn-sm btn-primary'>Salir</button></a>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<table class="table">
										...
										<tbody>
											<?php while ($row_msg_contatos = mysqli_fetch_assoc($resultado_msg_contatos)) { ?>
												<tr>
													<!-- <td class="text-center"><?php //echo $row_msg_contatos["id"]; 
																					?></td> -->
													<td class="text-center"><?php echo $row_msg_contatos["movil"]; ?></td>
													<td class="text-center"><?php echo $row_msg_contatos["apellido_titu"]; ?></td>
